                            ...
                            <div class="mt-8 ">
                                <div class="bg-gray-200  rounded-lg drop-shadow-lg p-4" style="background-image:url('./img/tttend.svg');background-size: cover;width:100%;height:100%;">
                                    ...
                                    <form class="mt-4" action="send_message.php" method="post" id="messageForm">
                                        ...
                                        <div class="relative">
                                            <input id="messageInput" class="w-full rounded-lg border border-gray-300 focus:outline focus:outline-violet-500 focus:caret-violet-950 caret-violet-900 px-4 py-2" name="message" placeholder="Write your message">
