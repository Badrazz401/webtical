            ...
            <div class="basis-1/2 p-4 bg-gray-200 rounded-md shadow-md text-black font-semibold">
                ...
                <div id="post" class="post">
                    ...
                    <div class="pl-14 grid ">
                        ...
                        <div class="flex justify-between p-4">&nbsp;
                            ...
                            <!-- <a href="post.php?idPub=<?php echo $idPub; ?>"><i class="fa-solid fa-comment text-violet-950 hover:text-violet-600 duration-300"></i></a> -->
                ...
                <div class="flex pt-4 justify-center">
                    ...
                    <form action="comment.php" method="post">
                        ...
                        <input type="text" name="comment" class="w-96 h-10 focus:outline focus:outline-violet-600 focus:bg-gray-200 placeholder:text-medium placeholder:text-gray-400 placeholder:italic  rounded-full pl-2 p-4 ml-4 mt-2" placeholder="Add a comment ..." required>
                        <button name="ok" class="rounded-full  text-white p-2 h-10 bg-teal-500 hover:bg-teal-700 duration-150">Comment</button>
                    </form>
                </div>
                <div class="pt-2"></div>
                <div class="grid pl-14 divide-y">
                    ...
                    ?>
                        <div id="post" class="post">
                            <div class="flex pt-4 space-x-2">
                                <div>
                                    <img src="./uploads/<?php echo $comment['name']; ?>" alt="" class="rounded-full w-12">
                                </div>
            ...
            <div class="basis-1/4 p-4 bg-gray-300 rounded-md shadow-md text-black font-semibold h-fit">
                <div class="relative text-gray-600 focus-withi:text-gray-400">
                    <span class="absolute inset-y-0 left-0 flex items-center pl-2">
                        <button type="submit" class="p-1 focus:outline-none focus:shadow-outline focus:border-indigo-500/100">
